...
const MissionVissionStage = () => {
  ...
  const Showstep = (step) => {
    ...
    return (
        ...
        <div className="MissionBoxHead MissionBoxHeadColor"  onClick={(e)=>{
            MissionButton(e)
        }}
        ><button >Mission</button></div>
        <div className="VissionBoxHead VissionBoxHeadColor" onClick={(e)=>{
            VissionButton(e)
        }}><button >Vission</button></div>
        </div>
